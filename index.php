            ...
            <div class="bg-white rounded-[2rem] p-8 sm:p-10 shadow-[0_32px_64px_-16px_rgba(0,73,0,0.08)] border border-gray-100 flex flex-col gap-6">
                ...
                <div class="flex flex-col gap-[15px] w-full mt-2">
                    ...
                    <div class="flex flex-col gap-[4px] w-full">
                        ...
                        <div class="w-full h-[50px] bg-input rounded-[15px] flex items-center gap-[10px] border-box py-0 px-[15px]">
                            <input type="password" name="password" id="password-input" class="border-none bg-transparent outline-none text-[16px] text-zinc-950 w-full focus:ring-0 focus:outline-none focus:border-transparent" placeholder="Tambahkan Password Anda">
                            
                            <button type="button" onclick="togglePassword()" class="text-gray-500 hover:text-gray-700 focus:outline-none flex-shrink-0 flex items-center justify-center p-1">
                                <!-- Eye Icon Open -->

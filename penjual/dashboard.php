    ...
    <div class="flex min-h-screen relative">
        ...
        <main class="lg:ml-80 flex-grow p-4 md:p-8 bg-surface pt-24 lg:pt-8">
            <header class="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-10 gap-4">
                <div>
                    <h2 class="font-headline font-extrabold text-3xl md:text-4xl tracking-tight text-primary">Selamat
                        Datang, Warung_ayam_bakar!</h2>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                ...
                <div
                    class="bg-white rounded-[20px] p-6 shadow-sm border border-gray-100 flex flex-col gap-2 col-span-2 lg:col-span-1">
                    <p class="text-xs font-semibold uppercase tracking-widest text-text-3">Toko Aktif</p>
                    <p class="text-4xl font-extrabold text-primary">12</p>
                    <p class="text-xs text-text-2">toko berjalan</p>
                </div>
            ...
            <div class="w-full bg-white rounded-[20px] mt-6 shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <div class="hidden md:grid grid-cols-[60px_1fr_120px_130px_100px] px-6 py-4 gap-4 items-center">
                        ...
                        <span
                            class="text-xs font-semibold px-2 py-1 rounded-full w-fit text-yellow-600 bg-yellow-100">Pending</span>
                    </div>
                    <div class="flex md:hidden items-center gap-3 px-4 py-4">
                        ...
                        <span
                            class="text-xs font-semibold px-2 py-1 rounded-full text-yellow-600 bg-yellow-100">Pending</span>
                    </div>
                </div>
                ...
                <div class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <div class="hidden md:grid grid-cols-[60px_1fr_120px_130px_100px] px-6 py-4 gap-4 items-center">
                        ...
                        <p class="text-sm text-text-3">28 Apr 2026</p>
                        <span
                            class="text-xs font-semibold px-2 py-1 rounded-full w-fit text-blue-600 bg-blue-100">Diproses</span>
                    </div>
                    <div class="flex md:hidden items-center gap-3 px-4 py-4">
                        <div class="flex-1 min-w-0">
                        ...
                        <span
                            class="text-xs font-semibold px-2 py-1 rounded-full text-blue-600 bg-blue-100">Diproses</span>
                    </div>
                </div>
                ...
                <div class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <div class="hidden md:grid grid-cols-[60px_1fr_120px_130px_100px] px-6 py-4 gap-4 items-center">
                        ...
                        <span
                            class="text-xs font-semibold px-2 py-1 rounded-full w-fit text-green-600 bg-green-100">Selesai</span>
                    </div>
                    <div class="flex md:hidden items-center gap-3 px-4 py-4">
                        <div class="flex-1 min-w-0">
                        ...
                        <span
                            class="text-xs font-semibold px-2 py-1 rounded-full text-green-600 bg-green-100">Selesai</span>
                    </div>
                </div>

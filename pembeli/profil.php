    ...
    <main class="lg:ml-80 flex-grow w-full px-4 md:px-8 pb-8 pt-[72px] lg:pt-8">
        <div class="w-full max-w-4xl mx-auto flex flex-col gap-6">
            ...
            <header class="animate-[fadeInUp_0.5s_ease-out_forwards] opacity-0" style="animation-delay: 0.1s;">
                <h2 class="font-extrabold text-3xl md:text-4xl tracking-tight text-primary">Akun Saya</h2>
                <p class="text-text-3 mt-1 text-sm">Kelola informasi profil Anda</p>
            </header>

            <!-- Konten profil akan diisi sesuai kebutuhan -->
